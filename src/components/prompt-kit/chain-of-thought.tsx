...
export const ChainOfThoughtItem = ({
  ...
  <div className={cn("text-[hsl(var(--app-muted))] text-sm", className)} {...props}>
    {children}
  </div>
);
...
export const ChainOfThoughtTrigger = ({
  ...
  <CollapsibleTrigger
    className={cn(
      "group text-[hsl(var(--app-muted))] hover:text-[hsl(var(--app-text))] flex cursor-pointer items-center justify-start gap-1 text-left text-sm transition-colors",
      className
    )}
    {...props}
  >
